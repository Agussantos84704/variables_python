...
print ("la suma de los valores ingresados (", numero_1, "y", numero_2,") es igual a: ", suma )
print ("la resta de los valores ingresados (", numero_1, "y", numero_2,") es igual a: ", resta )
print ("la multiplicacion entre los valores ingresados (", numero_1, "y", numero_2,") es igual a: ", multiplicacion )
print ("la division entre los valores ingresados (", numero_1, "y", numero_2,") es igual a: ", division )
