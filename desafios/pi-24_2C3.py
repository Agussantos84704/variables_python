...
nombre_completo = input('Ingrese su nombre completo por favor: ')
...
print("Procesados sus nombres en variables de tamaño: ", nombre_completo,", ", nombre_lower,", ", nombre_upper,", ", nombre_capitalize,)